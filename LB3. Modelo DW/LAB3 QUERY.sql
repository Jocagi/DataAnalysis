...
ALTER TABLE [dbo].[Invoices]  WITH CHECK ADD  CONSTRAINT [Clientes_FK] FOREIGN KEY([StockItemID])
...
ALTER TABLE [dbo].[Invoices]  WITH CHECK ADD  CONSTRAINT [StockItem_FK] FOREIGN KEY([CustomerID])
